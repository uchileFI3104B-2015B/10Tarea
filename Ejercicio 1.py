...
wave, flux = datos()
n = len(wave)
seeds = 9.e-17, 8.e-21, 1.e-17, 6550., 10. # Semillas para el ajuste, sacadas del grafico espectro (a, b, A, mu, sigma)
...
print 'Modelo Gauss:'
print 'a =', poptg[0], 'b =', poptg[1], 'A =', poptg[2], 'mu =', poptg[3], 'sigma =', poptg[4], 'chi**2 = ', chi(rectagauss, wave, flux, poptg)
print 'Modelo Lorentz:'
print 'a =', poptl[0], 'b =', poptl[1], 'A =', poptl[2], 'mu =', poptl[3], 'sigma =', poptl[4], 'chi**2 = ', chi(rectalorentz, wave, flux, poptl)
...
ax1.plot(wave, rectalorentz(wave, *poptl), 'r-', linewidth = '1.5', label="Ajuste Lorentz")
ax1.plot(wave, rectagauss(wave, *poptg), 'g-', linewidth = '1.5', label="Ajuste Gauss")
