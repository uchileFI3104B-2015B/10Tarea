...
GA,Gmu,Gsigma,Ga,Gb= ga
LA,Lmu,Lsigma,La,Lb= lo

chig=chi(ga,w,f,resta_gauss)
chil=chi(lo,w,f,resta_lorentz)

print "Gauss: A, mu, sigma, a, b =",ga
print "Lorentz: A, mu, sigma, a, b =",lo

print "Chi^2 Gauss",chig
print "Chi^2 Lorentz",chil
